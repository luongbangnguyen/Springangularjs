...
<ul class="nav navbar-right top-nav">
	...
	<li class="dropdown" ng-controller="user"><a href="#"
		class="dropdown-toggle" data-toggle="dropdown"><i
			class="fa fa-user"></i> {{user.data == null ? 'User' :
			user.data.fistName + ' ' + user.data.lastName}}<b class="caret"></b></a>
		<ul class="dropdown-menu">
			<li><a href="{{user.data == null ? '#' : 'profile'}}"><i
					class="fa fa-fw fa-user"></i> Profile</a></li>
			<li><a href="#"><i class="fa fa-fw fa-envelope"></i> Inbox</a></li>
			<li><a href="#"><i class="fa fa-fw fa-gear"></i> Settings</a></li>
			<li class="divider"></li>
			<li><a href="{{user.data == null ? 'login' : 'home'}}"
				ng-click="logout()"><i class="fa fa-fw fa-power-off"></i>{{user.data
					== null ? 'Log in' : 'Log out'}}</a></li>
		</ul></li>
</ul>