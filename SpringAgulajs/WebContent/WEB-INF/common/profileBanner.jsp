		...
		<div class="col-md-4 user-menu user-pad">
			<div class="user-menu-content">
				...
				<ul class="user-menu-list">
					...
					<li>
						<h4>
							<i class="fa fa-paper-plane-o coral"></i> Gracie Jenkins followed
							you.
						</h4>
					</li>
					<li>
					...
					<div class="col-md-6">
						<div class="view">
							<div class="caption">
								...
								<a href="" rel="tooltip" title=""
									data-original-title="Appreciate"><span
									class="fa fa-heart-o fa-2x"></span></a> <a href="" rel="tooltip"
									title="" data-original-title="View"><span
						...
						<div class="info">
							...
							<p class="small coral text-right">
								<i class="fa fa-clock-o"></i> Posted Today | 10:42 A.M.
							</p>
						</div>
				...
				<div class="share-links">
					...
					<center>
						<button type="button" class="btn btn-lg btn-labeled btn-warning"
							href="#">
							<span class="btn-label"><i class="fa fa-bell-o"></i></span>A WORK
							IN PROGRESS
						</button>
					</center>
				</div>
